...
\frame{
    ...
    \begin{align}
    	P(f_1^n|e_1^m) &= \int p(\textcolor{blue}{\theta}|\alpha) P(f_1^n|e_1^m, \textcolor{blue}{\theta}) \mathrm{d}\textcolor{blue}{\theta} \\
			&= \int p(\textcolor{blue}{\theta}|\alpha) \prod_{j=1}^n \sum_{a_j=0}^m P(a_j|m) P(f_j|e_{a_j}, \textcolor{blue}{\theta}) \mathrm{d}\textcolor{blue}{\theta}
	\end{align}
...
\frame{
	...
	\begin{align}
		...
		&= \argmax_{\lambda, \phi} \sum_{j=1}^m \mathbb E_q[\log P(a_j|m) P(f_j|e_{a_j}, \theta) - Q(a_j|\phi_j)] \\
		& ~~~~~~~~~~~ +\sum_\me \mathbb E_q[\log p(\theta_e|\alpha) - q(\theta_e|\lambda_e)]
	\end{align}
