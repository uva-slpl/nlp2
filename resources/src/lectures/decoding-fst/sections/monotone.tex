...
\frame{
	...
	\input{frames/w2w_enumerate_solutions.tex}
...
\frame{
	...
	\input{frames/w2w_expressiveness.tex}	
}

\frame{
	\frametitle{Compact representation}

	\input{frames/w2w_model.tex}
...
\frame{
	...
	\input{frames/w2w_intersection.tex}	
